...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Panggil API untuk mendapatkan daftar tim Liga Inggris
        getEnglishPremierLeagueTeams();
    }

    private void getEnglishPremierLeagueTeams() {
        Call<TeamsResponse> call = RetrofitClient.getInstance().getSportDBApi().getAllTeams("English Premier League");
            ...
            public void onResponse(Call<TeamsResponse> call, Response<TeamsResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (teams != null && !teams.isEmpty()) {
                        ...
                        Toast.makeText(MainActivity.this, "Tidak ada tim ditemukan di Liga Inggris.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(MainActivity.this, "Gagal mendapatkan data tim.", Toast.LENGTH_SHORT).show();
                }
            }
